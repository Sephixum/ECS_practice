...
3. Implement basics of Game class:
    a. Construct a Player Entity Using spawnPlayer()
    b. Implement basic drawing of entities using Game::sRender()
    c. Construct some enemies using the spawnEnemy()
    d. Construct a bullet using the spawnBullet()
4. Implement Player Movement in Gmae::sUserInput and Game::sMovement
5. Implement the EntityManager::update() function so it deletes dead entities
6. Implement the EntityManager::getEntities(tag) functioanlity
